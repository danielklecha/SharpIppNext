            ...
            serverRequest = await server.ReceiveRequestAsync(s, c);
                serverResponse = new GetPrinterAttributesResponse
                {
                    ...
                    PrinterAttributes = new()
                    {
                        ...
                        MaterialsColDatabase = new[] { new Material { MaterialKey = "db-key" } },
                        MaterialsColDefault = new[] { new Material { MaterialKey = "def-key" } },
                        MaterialsColReady = new[] { new Material { MaterialKey = "ready-key" } },
                        ...
                        MaterialsColSupported = new[] { "materials-col-sup" },
                        MaxMaterialsColSupported = 10,
                        MultipleObjectHandlingDefault = "auto",
                        MultipleObjectHandlingSupported = new[] { "auto" },
                        PdfFeaturesSupported = new[] { "prc" },
                        ...
                        PrintBaseSupported = new[] { "raft" },
                        PrintObjectsSupported = new[] { "all" },
                        PrintSupportsDefault = "standard",
                        ConfirmationSheetPrintDefault = true,
                        CoverSheetInfoDefault = new CoverSheetInfo(),
                        CoverSheetInfoSupported = new[] { "cover-sheet-info" },
                        ...
                        InputAttributesSupported = new[] { "input-attributes" },
                        InputColorModeSupported = new[] { "color" },
                        InputContentTypeSupported = new[] { "application/pdf" },
                        InputFilmScanModeSupported = new[] { "color" },
                        ...
                        ToNameSupported = 64,
                        DocumentAccessSupported = ["http://access.com"],
                        FetchDocumentAttributesSupported = ["document-name"],
                        PrinterModeConfigured = "standard",
                        PrinterModeSupported = ["standard"],
