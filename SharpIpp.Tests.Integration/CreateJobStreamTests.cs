    ...
    public async Task CreateJobAsync_WhenSendingStream_ServerReceivesSameRequestAndReturnsExpectedResponse()
    {
        ...
        CreateJobRequest clientRequest = new()
        {
            ...
            JobTemplateAttributes = new()
            {
                ...
                JobAccountingSheets = new JobAccountingSheets { JobAccountingOutputBin = OutputBin.Top, JobAccountingSheetsType = JobAccountingSheetsType.Standard },
                JobCompleteBefore = JobCompleteBefore.DayTime,
                JobCompleteBeforeTime = new DateTimeOffset(2025, 12, 31, 10, 0, 0, TimeSpan.Zero),
                JobErrorSheet = new JobErrorSheet { JobErrorSheetType = JobErrorSheetType.Standard, JobErrorSheetWhen = JobErrorSheetWhen.OnError },
