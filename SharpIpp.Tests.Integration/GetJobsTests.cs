            ...
            serverResponse = new GetJobsResponse
            {
                ...
                [
                    new JobDescriptionAttributes
                    {
                        ...
                        JobAccountingSheetsActual = [new JobAccountingSheets { JobAccountingSheetsType = JobAccountingSheetsType.None }],
                        JobAccountingUserIdActual = ["user-1"],
                        JobErrorSheetActual = [new JobErrorSheet { JobErrorSheetType = JobErrorSheetType.None }],
