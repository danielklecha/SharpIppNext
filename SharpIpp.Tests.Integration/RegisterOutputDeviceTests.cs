...
{
    [TestMethod]
    public async Task RegisterOutputDeviceAsync_WithCertificate_WhenSendingRequestAndReceivingResponse_ServerReceivesSameRequestAndReturnsExpectedResponse()
    {
    ...
    [TestMethod]
    public async Task RegisterOutputDeviceAsync_WithRequest_WhenSendingRequestAndReceivingResponse_ServerReceivesSameRequestAndReturnsExpectedResponse()
    {
        var clientRequest = new RegisterOutputDeviceRequest
        {
            RequestId = 810,
