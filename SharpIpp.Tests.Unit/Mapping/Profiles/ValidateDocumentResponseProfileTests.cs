...
public class ValidateDocumentResponseProfileTests : MapperTestBase
{
    [TestMethod]
    public void Map_ValidateDocumentResponse_RoundTrip_WithPreferredAttributes_ShouldSucceed()
    {
        // Arrange
        ...
        var message = _mapper.Map<ValidateDocumentResponse, IppResponseMessage>(response);
        ...
        // Act - Map back to ValidateDocumentResponse
        var roundTrip = _mapper.Map<IppResponseMessage, ValidateDocumentResponse>(message);
    ...
    [TestMethod]
    public void Map_ValidateDocumentResponse_RoundTrip_WithNullOperationAttributes_ShouldSucceed()
    {
        // Arrange
        var response = new ValidateDocumentResponse
        {
    ...
    [TestMethod]
    public void Map_ValidateDocumentResponse_RoundTrip_WithNullPreferredAttributes_ShouldSucceed()
    {
        // Arrange
        var response = new ValidateDocumentResponse
        {
