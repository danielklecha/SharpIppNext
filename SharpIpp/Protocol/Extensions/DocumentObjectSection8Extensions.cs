...
/// <summary>
/// Helpers for PWG 5100.5-2024 Section 8 document object behavior.
/// These helpers are opt-in and do not alter the default client or server pipeline behavior.
/// </summary>
public static class DocumentObjectSection8Extensions
{
    public static void ValidateSection8DocumentResponse(this PrintJobResponse? response)
    {
        ValidateOptionalDocumentResponse(response?.DocumentAttributes, nameof(response));
    }

    public static void ValidateSection8DocumentResponse(this PrintUriResponse? response)
    {
        ValidateOptionalDocumentResponse(response?.DocumentAttributes, nameof(response));
    }

    public static void ValidateSection8DocumentResponse(this SendDocumentResponse? response)
    {
        ValidateRequiredDocumentResponse(response?.DocumentAttributes, nameof(response));
    }

    public static void ValidateSection8DocumentResponse(this SendUriResponse? response)
    {
        ValidateRequiredDocumentResponse(response?.DocumentAttributes, nameof(response));
    }
    ...
    private static void ValidateOptionalDocumentResponse(DocumentAttributes? documentAttributes, string paramName)
    {
    ...
    private static void ValidateRequiredDocumentResponse(DocumentAttributes? documentAttributes, string paramName)
    {
        if (documentAttributes == null)
