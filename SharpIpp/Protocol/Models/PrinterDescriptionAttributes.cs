...
public class PrinterDescriptionAttributes
{
    ...
    /// <summary>
    /// printer-detailed-status-messages (PWG 5100.7-2023 Section 6.10.1)
    /// </summary>
    ...
    /// <summary>
    /// multiple-document-handling-default (RFC 2911 Section 4.2.4)
    /// </summary>
    public MultipleDocumentHandling? MultipleDocumentHandlingDefault { get; set; }

    /// <summary>
    /// multiple-document-handling-supported (RFC 2911 Section 4.2.4)
    /// </summary>
    ...
    /// <summary>
    /// client-info-supported (PWG 5100.7-2023 Section 6.9.5)
    /// </summary>
    public string[]? ClientInfoSupported { get; set; }

    /// <summary>
    /// max-client-info-supported (PWG 5100.7-2023 Section 6.9.41)
    /// </summary>
    public int? MaxClientInfoSupported { get; set; }

    /// <summary>
    /// document-charset-default (PWG 5100.7-2023 Section 6.9.16)
    /// </summary>
    public string? DocumentCharsetDefault { get; set; }

    /// <summary>
    /// document-charset-supported (PWG 5100.7-2023 Section 6.9.17)
    /// </summary>
    public string[]? DocumentCharsetSupported { get; set; }

    /// <summary>
    /// document-format-details-supported (PWG 5100.7-2023 Section 6.9.20)
    /// </summary>
    public string[]? DocumentFormatDetailsSupported { get; set; }

    /// <summary>
    /// document-natural-language-default (PWG 5100.7-2023 Section 6.9.48)
    /// </summary>
    public string? DocumentNaturalLanguageDefault { get; set; }

    /// <summary>
    /// document-natural-language-supported (PWG 5100.7-2023 Section 6.9.49)
    /// </summary>
    public string[]? DocumentNaturalLanguageSupported { get; set; }

    /// <summary>
    /// job-ids-supported (PWG 5100.7-2023 Section 6.9.26)
    /// </summary>
    public bool? JobIdsSupported { get; set; }

    /// <summary>
    /// job-mandatory-attributes-supported (PWG 5100.7-2023 Section 6.9.28)
    /// </summary>
    public bool? JobMandatoryAttributesSupported { get; set; }

    /// <summary>
    /// job-sheets-col-default (PWG 5100.7-2023 Section 6.9.29)
    /// </summary>
    public JobSheetsCol? JobSheetsColDefault { get; set; }

    /// <summary>
    /// job-sheets-col-supported (PWG 5100.7-2023 Section 6.9.30)
    /// </summary>
    ...
    /// <summary>
    /// job-sheets-default (RFC 2911 Section 4.2.3)
    /// </summary>
    public JobSheets? JobSheetsDefault { get; set; }

    /// <summary>
    /// job-sheets-supported (RFC 2911 Section 4.2.3)
    /// </summary>
    public JobSheets[]? JobSheetsSupported { get; set; }

    /// <summary>
    /// number-up-default (RFC 2911 Section 4.2.7)
    /// </summary>
    public int? NumberUpDefault { get; set; }

    /// <summary>
    /// number-up-supported (RFC 2911 Section 4.2.7)
    /// </summary>
    ...
    /// <summary>
    /// media-ready (RFC 2911 Section 4.2.11)
    /// </summary>
    ...
    /// <summary>
    /// job-hold-until-time-supported (PWG 5100.7-2023 Section 6.9.21)
    /// </summary>
    public bool? JobHoldUntilTimeSupported { get; set; }

    /// <summary>
    /// job-delay-output-until-default (PWG 5100.7-2023 Section 6.9.14)
    /// </summary>
    public JobHoldUntil? JobDelayOutputUntilDefault { get; set; }

    /// <summary>
    /// job-delay-output-until-supported (PWG 5100.7-2023 Section 6.9.15)
    /// </summary>
    public JobHoldUntil[]? JobDelayOutputUntilSupported { get; set; }

    /// <summary>
    /// job-delay-output-until-time-supported (PWG 5100.7-2023 Section 6.9.16)
    /// </summary>
    public Range? JobDelayOutputUntilTimeSupported { get; set; }

    /// <summary>
    /// job-history-attributes-configured (PWG 5100.7-2023 Section 6.9.17)
    /// </summary>
    public string[]? JobHistoryAttributesConfigured { get; set; }

    /// <summary>
    /// job-history-attributes-supported (PWG 5100.7-2023 Section 6.9.18)
    /// </summary>
    public string[]? JobHistoryAttributesSupported { get; set; }

    /// <summary>
    /// job-history-interval-configured (PWG 5100.7-2023 Section 6.9.19)
    /// </summary>
    public int? JobHistoryIntervalConfigured { get; set; }

    /// <summary>
    /// job-history-interval-supported (PWG 5100.7-2023 Section 6.9.20)
    /// </summary>
    public Range? JobHistoryIntervalSupported { get; set; }

    /// <summary>
    /// job-retain-until-default (PWG 5100.7-2023 Section 6.9.24)
    /// </summary>
    public JobHoldUntil? JobRetainUntilDefault { get; set; }

    /// <summary>
    /// job-retain-until-interval-default (PWG 5100.7-2023 Section 6.9.25)
    /// </summary>
    public int? JobRetainUntilIntervalDefault { get; set; }

    /// <summary>
    /// job-retain-until-interval-supported (PWG 5100.7-2023 Section 6.9.26)
    /// </summary>
    public Range? JobRetainUntilIntervalSupported { get; set; }

    /// <summary>
    /// job-retain-until-supported (PWG 5100.7-2023 Section 6.9.27)
    /// </summary>
    public JobHoldUntil[]? JobRetainUntilSupported { get; set; }

    /// <summary>
    /// job-retain-until-time-supported (PWG 5100.7-2023 Section 6.9.28)
    /// </summary>
    ...
    /// <summary>
    /// media-col-database (PWG 5100.7-2023 Section 6.9.36)
    /// </summary>
    public MediaCol[]? MediaColDatabase { get; set; }

    /// <summary>
    /// media-col-ready (PWG 5100.7-2023 Section 6.9.38)
    /// </summary>
    public MediaCol[]? MediaColReady { get; set; }

    /// <summary>
    /// media-col-supported (PWG 5100.7-2023 Section 6.9.39)
    /// </summary>
    public string[]? MediaColSupported { get; set; }

    /// <summary>
    /// media-size-supported (PWG 5100.7-2023 Section 6.9.50)
    /// </summary>
    public MediaSizeSupported[]? MediaSizeSupported { get; set; }

    /// <summary>
    /// media-key-supported (PWG 5100.7-2023 Section 6.9.44)
    /// </summary>
    public string[]? MediaKeySupported { get; set; }

    /// <summary>
    /// media-source-supported (PWG 5100.7-2023 Section 6.9.51)
    /// </summary>
    public MediaSource[]? MediaSourceSupported { get; set; }

    /// <summary>
    /// media-type-supported (PWG 5100.7-2023 Section 6.9.55)
    /// </summary>
    public MediaType[]? MediaTypeSupported { get; set; }

    /// <summary>
    /// media-back-coating-supported (PWG 5100.7-2023 Section 6.9.34)
    /// </summary>
    public MediaCoating[]? MediaBackCoatingSupported { get; set; }

    /// <summary>
    /// media-front-coating-supported (PWG 5100.7-2023 Section 6.9.41)
    /// </summary>
    public MediaCoating[]? MediaFrontCoatingSupported { get; set; }

    /// <summary>
    /// media-color-supported (PWG 5100.7-2023 Section 6.9.40)
    /// </summary>
    public MediaColor[]? MediaColorSupported { get; set; }

    /// <summary>
    /// media-grain-supported (PWG 5100.7-2023 Section 6.9.42)
    /// </summary>
    public MediaGrain[]? MediaGrainSupported { get; set; }

    /// <summary>
    /// media-tooth-supported (PWG 5100.7-2023 Section 6.9.53)
    /// </summary>
    public MediaTooth[]? MediaToothSupported { get; set; }

    /// <summary>
    /// media-pre-printed-supported (PWG 5100.7-2023 Section 6.9.47)
    /// </summary>
    public MediaPrePrinted[]? MediaPrePrintedSupported { get; set; }

    /// <summary>
    /// media-recycled-supported (PWG 5100.7-2023 Section 6.9.48)
    /// </summary>
    public MediaRecycled[]? MediaRecycledSupported { get; set; }

    /// <summary>
    /// media-hole-count-supported (PWG 5100.7-2023 Section 6.9.43)
    /// </summary>
    public Range[]? MediaHoleCountSupported { get; set; }

    /// <summary>
    /// media-order-count-supported (PWG 5100.7-2023 Section 6.9.46)
    /// </summary>
    public Range[]? MediaOrderCountSupported { get; set; }

    /// <summary>
    /// media-thickness-supported (PWG 5100.7-2023 Section 6.9.52)
    /// </summary>
    public Range[]? MediaThicknessSupported { get; set; }

    /// <summary>
    /// media-weight-metric-supported (PWG 5100.7-2023 Section 6.9.56)
    /// </summary>
    public Range[]? MediaWeightMetricSupported { get; set; }

    /// <summary>
    /// media-bottom-margin-supported (PWG 5100.7-2023 Section 6.9.35)
    /// </summary>
    public int[]? MediaBottomMarginSupported { get; set; }

    /// <summary>
    /// media-left-margin-supported (PWG 5100.7-2023 Section 6.9.45)
    /// </summary>
    public int[]? MediaLeftMarginSupported { get; set; }

    /// <summary>
    /// media-right-margin-supported (PWG 5100.7-2023 Section 6.9.49)
    /// </summary>
    public int[]? MediaRightMarginSupported { get; set; }

    /// <summary>
    /// media-top-margin-supported (PWG 5100.7-2023 Section 6.9.54)
    /// </summary>
    ...
    /// <summary>
    /// printer-requested-client-type (PWG 5100.7-2023 Section 6.9.60)
    /// </summary>
    ...
    /// <summary>
    /// page-delivery-default (PWG 5100.3-2023 Section 4.2 / 11.1)
    /// </summary>
    public PageDelivery? PageDeliveryDefault { get; set; }

    /// <summary>
    /// page-delivery-supported (PWG 5100.3-2023 Section 4.2 / 11.1)
    /// </summary>
