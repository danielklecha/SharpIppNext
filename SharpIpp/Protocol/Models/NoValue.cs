...
public struct NoValue : IEquatable<NoValue>
{
    ...
    public static bool IsNoValue(object value, Tag tag = Tag.Unknown)
    {
        return value switch
        {
            ...
            PageOrderReceived pageOrderReceived when pageOrderReceived.Value == string.Empty => true,
            ...
            CurrentPageOrder currentPageOrder when currentPageOrder.Value == string.Empty => true,
    ...
    public static object GetNoValue(Type type, Tag tag = Tag.Unknown)
    {
        ...
        return underlyingType switch
        {
            ...
            _ when underlyingType == typeof(PageOrderReceived) => new PageOrderReceived(string.Empty),
            ...
            _ when underlyingType == typeof(CurrentPageOrder) => new CurrentPageOrder(string.Empty),
