...
public readonly record struct Media(string Value, bool IsMarked = true, bool IsValue = true) : IMarkedSmartEnum
{
    ...
    public static implicit operator Media(string value) => value is null ? throw new System.ArgumentNullException(nameof(value)) : new(value);
}
