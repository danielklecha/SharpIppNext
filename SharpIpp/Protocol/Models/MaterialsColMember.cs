...
public readonly record struct MaterialsColMember(string Value, bool IsMarked = true, bool IsValue = true) : IMarkedSmartEnum
{
    ...
    /// <summary>
    /// The material-color member attribute.
    /// See: PWG 5100.21-2019 Section 8.1.18
    /// </summary>
    public static readonly MaterialsColMember MaterialColor = new("material-color");

    /// <summary>
    /// The material-diameter member attribute.
    /// See: PWG 5100.21-2019 Section 8.1.18
    /// </summary>
    public static readonly MaterialsColMember MaterialDiameter = new("material-diameter");

    /// <summary>
    /// The material-fill-density member attribute.
    /// See: PWG 5100.21-2019 Section 8.1.18
    /// </summary>
    public static readonly MaterialsColMember MaterialFillDensity = new("material-fill-density");

    /// <summary>
    /// The material-key member attribute.
    /// See: PWG 5100.21-2019 Section 8.1.18
    /// </summary>
    public static readonly MaterialsColMember MaterialKey = new("material-key");

    /// <summary>
    /// The material-name member attribute.
    /// See: PWG 5100.21-2019 Section 8.1.18
    /// </summary>
    public static readonly MaterialsColMember MaterialName = new("material-name");

    /// <summary>
    /// The material-purpose member attribute.
    /// See: PWG 5100.21-2019 Section 8.1.18
    /// </summary>
    public static readonly MaterialsColMember MaterialPurpose = new("material-purpose");

    /// <summary>
    /// The material-rate member attribute.
    /// See: PWG 5100.21-2019 Section 8.1.18
    /// </summary>
    public static readonly MaterialsColMember MaterialRate = new("material-rate");

    /// <summary>
    /// The material-rate-units member attribute.
    /// See: PWG 5100.21-2019 Section 8.1.18
    /// </summary>
    public static readonly MaterialsColMember MaterialRateUnits = new("material-rate-units");

    /// <summary>
    /// The material-shell-thickness member attribute.
    /// See: PWG 5100.21-2019 Section 8.1.18
    /// </summary>
    public static readonly MaterialsColMember MaterialShellThickness = new("material-shell-thickness");

    /// <summary>
    /// The material-temperature member attribute.
    /// See: PWG 5100.21-2019 Section 8.1.18
    /// </summary>
    public static readonly MaterialsColMember MaterialTemperature = new("material-temperature");

    /// <summary>
    /// The material-type member attribute.
    /// See: PWG 5100.21-2019 Section 8.1.18
    /// </summary>
