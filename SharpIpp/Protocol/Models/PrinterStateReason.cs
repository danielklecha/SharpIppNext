...
public readonly record struct PrinterStateReason(string Value)
{
    ...
    public static readonly PrinterStateReason OpcAlmostFull = new("opc-almost-full");
    public static readonly PrinterStateReason OpcFull = new("opc-full");
    ...
    public static readonly PrinterStateReason StoppedPartially = new("stopped-partially");
