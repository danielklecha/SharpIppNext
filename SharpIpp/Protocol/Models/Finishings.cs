...
{
    /// <summary>
    /// IPP finishings attribute values specifying post-processing operations to apply to printed output.
    ...
    public enum Finishings
    {
        ...
        /// either by drilling/punching, or by substituting pre-drilled media.
        /// See: RFC 8011 Section 5.2.6
        /// </summary>
        Punch = 5,
        ...
        /// to the document; the type and placement of the binding is site-defined.
        /// See: RFC 8011 Section 5.2.6
        /// </summary>
        Bind = 7,
        ...
        /// The exact number and placement of the staples and the middle fold is implementation and/or site-defined.
        /// See: RFC 8011 Section 5.2.6
        /// </summary>
        SaddleStitch = 8,
        ...
        /// The exact number and placement of the staples is implementation and/or site-defined.
        /// See: RFC 8011 Section 5.2.6
        /// </summary>
        EdgeStitch = 9,
        ...
        /// <summary>
        /// Bind the document(s) with three staples (wire stitches) along the left edge assuming a portrait document.
        /// See: PWG 5100.1-2022 Section 6.1
        /// </summary>
        StapleTripleLeft = 32,

        /// <summary>
        /// Bind the document(s) with three staples (wire stitches) along the top edge assuming a portrait document.
        /// See: PWG 5100.1-2022 Section 6.1
        /// </summary>
        StapleTripleTop = 33,

        /// <summary>
        /// Bind the document(s) with three staples (wire stitches) along the right edge assuming a portrait document.
        /// See: PWG 5100.1-2022 Section 6.1
        /// </summary>
        StapleTripleRight = 34,

        /// <summary>
        /// Bind the document(s) with three staples (wire stitches) along the bottom edge assuming a portrait document.
        /// See: PWG 5100.1-2022 Section 6.1
        /// </summary>
        StapleTripleBottom = 35,

        /// <summary>
        /// Fold the hardcopy output. The exact number and orientations of the folds is implementation and/or site-defined.
        /// See: PWG 5100.1-2022 Section 6.1
        /// </summary>
        Fold = 10,
        ...
        /// <summary>
        /// Bale the document(s). The type of baling is implementation and/or site-defined.
        /// See: PWG 5100.1-2022 Section 6.1
        /// </summary>
        Bale = 12,
        ...
        /// This value is a short cut for specifying a Job that is to be folded, trimmed and then saddle-stitched.
        /// See: PWG 5100.1-2022 Section 6.1
        /// </summary>
        BookletMaker = 13,
