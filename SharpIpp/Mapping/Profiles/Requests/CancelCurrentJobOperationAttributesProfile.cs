...
internal class CancelCurrentJobOperationAttributesProfile : IProfile
{
    public void CreateMaps(IMapperConstructor mapper)
    {
        mapper.CreateMap<IDictionary<string, IppAttribute[]>, CancelCurrentJobOperationAttributes>((src, dst, map) =>
        {
            dst ??= new CancelCurrentJobOperationAttributes();
        ...
        mapper.CreateMap<CancelCurrentJobOperationAttributes, List<IppAttribute>>((src, dst, map) =>
        {
