...
internal class DeactivatePrinterOperationAttributesProfile : IProfile
{
    public void CreateMaps(IMapperConstructor mapper)
    {
        mapper.CreateMap<IDictionary<string, IppAttribute[]>, DeactivatePrinterOperationAttributes>((src, dst, map) =>
        {
            dst ??= new DeactivatePrinterOperationAttributes();
        ...
        mapper.CreateMap<DeactivatePrinterOperationAttributes, List<IppAttribute>>((src, dst, map) =>
        {
