...
internal class StartupPrinterOperationAttributesProfile : IProfile
{
    public void CreateMaps(IMapperConstructor mapper)
    {
        mapper.CreateMap<IDictionary<string, IppAttribute[]>, StartupPrinterOperationAttributes>((src, dst, map) =>
        {
            dst ??= new StartupPrinterOperationAttributes();
        ...
        mapper.CreateMap<StartupPrinterOperationAttributes, List<IppAttribute>>((src, dst, map) =>
        {
