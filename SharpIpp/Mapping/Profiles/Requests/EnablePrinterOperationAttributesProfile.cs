...
internal class EnablePrinterOperationAttributesProfile : IProfile
{
    public void CreateMaps(IMapperConstructor mapper)
    {
        mapper.CreateMap<IDictionary<string, IppAttribute[]>, EnablePrinterOperationAttributes>((src, dst, map) =>
        {
            dst ??= new EnablePrinterOperationAttributes();
        ...
        mapper.CreateMap<EnablePrinterOperationAttributes, List<IppAttribute>>((src, dst, map) =>
        {
