...
internal class ActivatePrinterOperationAttributesProfile : IProfile
{
    public void CreateMaps(IMapperConstructor mapper)
    {
        mapper.CreateMap<IDictionary<string, IppAttribute[]>, ActivatePrinterOperationAttributes>((src, dst, map) =>
        {
            dst ??= new ActivatePrinterOperationAttributes();
        ...
        mapper.CreateMap<ActivatePrinterOperationAttributes, List<IppAttribute>>((src, dst, map) =>
        {
