    ...
    public void CreateMaps(IMapperConstructor mapper)
    {
        ...
        mapper.CreateMap<IDictionary<string, IppAttribute[]>, SystemStatusAttributes>((src, map) =>
        {
            var dst = new SystemStatusAttributes
            {
                ...
                SystemStateReasons = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.SystemStateReasons),
                ...
                SystemTimeSourceConfigured = map.MapFromDicNullable<string?>(src, SystemAttribute.SystemTimeSourceConfigured),
        ...
        mapper.CreateMap<IDictionary<string, IppAttribute[]>, SystemDescriptionAttributes>((src, map) =>
        {
            return new SystemDescriptionAttributes
            {
                ...
                IppFeaturesSupported = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.IppFeaturesSupported),
                ...
                OutputDeviceX509TypeSupported = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.OutputDeviceX509TypeSupported),
                ...
                PrinterCreationAttributesSupported = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.PrinterCreationAttributesSupported),
                ...
                ResourceTypeSupported = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.ResourceTypeSupported),
                ResourceSettableAttributesSupported = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.ResourceSettableAttributesSupported),
                NotifyAttributesSupported = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.NotifyAttributesSupported),
                NotifyEventsDefault = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.NotifyEventsDefault),
                NotifyEventsSupported = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.NotifyEventsSupported),
                ...
                NotifyPullMethodSupported = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.NotifyPullMethodSupported),
                ...
                SystemMandatoryPrinterAttributes = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.SystemMandatoryPrinterAttributes),
                SystemMandatoryRegistrationAttributes = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.SystemMandatoryRegistrationAttributes),
                SystemSettableAttributesSupported = map.MapFromDicSetNullable<string[]?>(src, SystemAttribute.SystemSettableAttributesSupported),
        ...
        mapper.CreateMap<GetSystemAttributesResponse, IppResponseMessage>((src, map) =>
        {
            ...
            if (src.SystemAttributes != null)
            {
                ...
                if (src.SystemAttributes.SystemStateReasons != null)
                    attrs.AddRange(src.SystemAttributes.SystemStateReasons.Select(x => new IppAttribute(Tag.Keyword, SystemAttribute.SystemStateReasons, x)));
                ...
                if (src.SystemAttributes.SystemTimeSourceConfigured != null)
                    attrs.Add(new IppAttribute(Tag.Keyword, SystemAttribute.SystemTimeSourceConfigured, src.SystemAttributes.SystemTimeSourceConfigured));
            ...
            if (src.SystemDescriptionAttributes != null)
            {
                ...
                if (src.SystemDescriptionAttributes.IppFeaturesSupported != null)
                    attrs.AddRange(src.SystemDescriptionAttributes.IppFeaturesSupported.Select(x => new IppAttribute(Tag.Keyword, SystemAttribute.IppFeaturesSupported, x)));
                ...
                if (src.SystemDescriptionAttributes.OutputDeviceX509TypeSupported != null)
                    attrs.AddRange(src.SystemDescriptionAttributes.OutputDeviceX509TypeSupported.Select(x => new IppAttribute(Tag.Keyword, SystemAttribute.OutputDeviceX509TypeSupported, x)));
                ...
                if (src.SystemDescriptionAttributes.PrinterCreationAttributesSupported != null)
                    attrs.AddRange(src.SystemDescriptionAttributes.PrinterCreationAttributesSupported.Select(x => new IppAttribute(Tag.Keyword, SystemAttribute.PrinterCreationAttributesSupported, x)));
                ...
                if (src.SystemDescriptionAttributes.ResourceTypeSupported != null)
                    attrs.AddRange(src.SystemDescriptionAttributes.ResourceTypeSupported.Select(x => new IppAttribute(Tag.Keyword, SystemAttribute.ResourceTypeSupported, x)));
                if (src.SystemDescriptionAttributes.ResourceSettableAttributesSupported != null)
                    attrs.AddRange(src.SystemDescriptionAttributes.ResourceSettableAttributesSupported.Select(x => new IppAttribute(Tag.Keyword, SystemAttribute.ResourceSettableAttributesSupported, x)));
                ...
                if (src.SystemDescriptionAttributes.SystemMandatoryPrinterAttributes != null)
                    attrs.AddRange(src.SystemDescriptionAttributes.SystemMandatoryPrinterAttributes.Select(x => new IppAttribute(Tag.Keyword, SystemAttribute.SystemMandatoryPrinterAttributes, x)));
                if (src.SystemDescriptionAttributes.SystemMandatoryRegistrationAttributes != null)
                    attrs.AddRange(src.SystemDescriptionAttributes.SystemMandatoryRegistrationAttributes.Select(x => new IppAttribute(Tag.Keyword, SystemAttribute.SystemMandatoryRegistrationAttributes, x)));
                if (src.SystemDescriptionAttributes.SystemSettableAttributesSupported != null)
                    attrs.AddRange(src.SystemDescriptionAttributes.SystemSettableAttributesSupported.Select(x => new IppAttribute(Tag.Keyword, SystemAttribute.SystemSettableAttributesSupported, x)));
                ...
                if (src.SystemDescriptionAttributes.NotifyEventsDefault != null)
                    attrs.AddRange(src.SystemDescriptionAttributes.NotifyEventsDefault.Select(x => new IppAttribute(Tag.Keyword, SystemAttribute.NotifyEventsDefault, x)));
                if (src.SystemDescriptionAttributes.NotifyEventsSupported != null)
                    attrs.AddRange(src.SystemDescriptionAttributes.NotifyEventsSupported.Select(x => new IppAttribute(Tag.Keyword, SystemAttribute.NotifyEventsSupported, x)));
                ...
                if (src.SystemDescriptionAttributes.NotifyPullMethodSupported != null)
                    attrs.AddRange(src.SystemDescriptionAttributes.NotifyPullMethodSupported.Select(x => new IppAttribute(Tag.Keyword, SystemAttribute.NotifyPullMethodSupported, x)));
                ...
                if (src.SystemDescriptionAttributes.SystemTimeSourceConfigured != null)
                    attrs.Add(new IppAttribute(Tag.Keyword, SystemAttribute.SystemTimeSourceConfigured, src.SystemDescriptionAttributes.SystemTimeSourceConfigured));
            }
