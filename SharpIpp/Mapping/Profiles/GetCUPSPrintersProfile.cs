        ...
        public void CreateMaps(IMapperConstructor mapper)
        {
            ...
            mapper.CreateMap<IDictionary<string, IppAttribute[]>, PrinterDescriptionAttributes>((src, map) =>
                new PrinterDescriptionAttributes
                {
                    ...
                    CharsetSupported = map.MapFromDicSet<string[]?>(src, PrinterAttribute.CharsetSupported),
                    ColorSupported = map.MapFromDic<bool?>(src, PrinterAttribute.ColorSupported),
                    CompressionSupported = map.MapFromDicSet<Compression[]?>(src, PrinterAttribute.CompressionSupported),
                    DocumentFormatDefault = map.MapFromDic<string?>(src, PrinterAttribute.DocumentFormatDefault),
                    DocumentFormatSupported = map.MapFromDicSet<string[]?>(src, PrinterAttribute.DocumentFormatSupported),
                    GeneratedNaturalLanguageSupported = map.MapFromDicSet<string[]?>(src, PrinterAttribute.GeneratedNaturalLanguageSupported),
                    IppVersionsSupported = map.MapFromDicSet<IppVersion[]?>(src, PrinterAttribute.IppVersionsSupported),
                    ...
                    OperationsSupported = map.MapFromDicSet<IppOperation[]?>(src, PrinterAttribute.OperationsSupported),
                    ...
                    PrinterStateReasons = map.MapFromDicSet<string[]?>(src, PrinterAttribute.PrinterStateReasons),
                    PrinterUpTime = map.MapFromDic<int?>(src, PrinterAttribute.PrinterUpTime),
                    PrinterUriSupported = map.MapFromDicSet<string[]?>(src, PrinterAttribute.PrinterUriSupported),
                    PrintScalingDefault = map.MapFromDic<PrintScaling?>(src, PrinterAttribute.PrintScalingDefault),
                    PrintScalingSupported = map.MapFromDicSet<PrintScaling[]?>(src, PrinterAttribute.PrintScalingSupported),
                    QueuedJobCount = map.MapFromDic<int?>(src, PrinterAttribute.QueuedJobCount),
                    ReferenceUriSchemesSupported = map.MapFromDicSet<UriScheme[]?>(src, PrinterAttribute.ReferenceUriSchemesSupported),
                    UriAuthenticationSupported = map.MapFromDicSet<UriAuthentication[]?>(src, PrinterAttribute.UriAuthenticationSupported),
                    UriSecuritySupported = map.MapFromDicSet<UriSecurity[]?>(src, PrinterAttribute.UriSecuritySupported),
                    MediaDefault = map.MapFromDic<string?>(src, PrinterAttribute.MediaDefault),
                    MediaSupported = map.MapFromDicSet<string[]?>(src, PrinterAttribute.MediaSupported),
                    SidesDefault = map.MapFromDic<Sides?>(src, PrinterAttribute.SidesDefault),
                    SidesSupported = map.MapFromDicSet<Sides[]?>(src, PrinterAttribute.SidesSupported),
                    FinishingsDefault = map.MapFromDic<Finishings?>(src, PrinterAttribute.FinishingsDefault),
                    FinishingsSupported = map.MapFromDicSet<Finishings[]?>(src, PrinterAttribute.FinishingsSupported),
                    PrinterResolutionDefault = map.MapFromDic<Resolution?>(src, PrinterAttribute.PrinterResolutionDefault),
                    PrinterResolutionSupported = map.MapFromDicSet<Resolution[]?>(src, PrinterAttribute.PrinterResolutionSupported),
                    PrintQualityDefault = map.MapFromDic<PrintQuality?>(src, PrinterAttribute.PrintQualityDefault),
                    PrintQualitySupported = map.MapFromDicSet<PrintQuality[]?>(src, PrinterAttribute.PrintQualitySupported),
                    ...
                    OrientationRequestedSupported = map.MapFromDicSet<Orientation[]?>(src, PrinterAttribute.OrientationRequestedSupported),
                    ...
                    JobHoldUntilSupported = map.MapFromDicSet<JobHoldUntil[]?>(src, PrinterAttribute.JobHoldUntilSupported),
                    OutputBinDefault = map.MapFromDic<string?>(src, PrinterAttribute.OutputBinDefault),
                    OutputBinSupported = map.MapFromDicSet<string[]?>(src, PrinterAttribute.OutputBinSupported),
                    ...
                    PrintColorModeSupported = map.MapFromDicSet<PrintColorMode[]?>(src, PrinterAttribute.PrintColorModeSupported),
                    WhichJobsSupported = map.MapFromDicSet<WhichJobs[]?>(src, PrinterAttribute.WhichJobsSupported),
