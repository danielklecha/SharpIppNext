...
/// <summary>
/// Validates high-level IPP requests using DataAnnotations validation recursively.
/// </summary>
public class IppRequestValidator : IIppRequestValidator
{
    ...
    public void Validate<T>(T request) where T : IIppRequest
    {
        ...
        ValidateObjectRecursive(request, validationResults, visited, items);
        ...
        IDictionary<object, object?> items)
    {
        ...
        var sharpIppAssembly = typeof(IppRequestValidator).Assembly;
